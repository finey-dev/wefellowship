...
enum RswipeablePageChangedReason { timed, manual, controller }

enum CenterPageEnlargeStrategy { scale, height, zoom }

class RswipeableOptions {
  ...
  final Function(int index, RswipeablePageChangedReason reason)? onPageChanged;
  ...
  ///Generate new [RswipeableOptions] based on old ones.

  RswipeableOptions copyWith(
          {double? height,
          double? aspectRatio,
          ...
          Function(int index, RswipeablePageChangedReason reason)? onPageChanged,
