...
abstract class RswipeableController {
  bool get ready;
  ...
  factory RswipeableController() => RswipeableControllerImpl();
}

class RswipeableControllerImpl implements RswipeableController {
  final Completer<Null> _readyCompleter = Completer<Null>();

  RswipeableState? _state;

  set state(RswipeableState? state) {
    _state = state;
  ...
  void _setModeController() =>
      _state!.changeMode(RswipeablePageChangedReason.controller);
